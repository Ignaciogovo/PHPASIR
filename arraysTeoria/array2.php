...
//Unir arrays diferencias intersecciones y orden
echo "<br>Unir arrays <br>";
$colores1=["Verde","Azul","Amarillo","Rojo"];
$colores2=["Verde","Azul","Amarillo","Rojo","Blanco","Negro"];
$resultadoDiferencia=array_diff($colores2,$colores1); // Aqui siempre el mas grande tiene que ir primero
$resultadoUnion=array_merge($colores1,$colores2);
$resultadoInterseccion=array_intersect($colores1,$colores2);
